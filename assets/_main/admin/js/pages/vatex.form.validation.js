var BlankonFormValidation = function () {
    ...
    return {
        ...
        jqueryValidation: function () {
            ...
            if($('#client-create-validation').length){

                $.mockjax({
                    url: 'emails.action2',
                    response: function(settings) {
                        var email = settings.data.contact_email,
                ...
                $.mockjax({
                    url: 'users.action2',
                    response: function(settings) {
                        var user = settings.data.unique_identifier,
                            users = ["john", "peter", "bill", "jokowi"];
                        this.responseText = "true";
                        if ( $.inArray( user, users ) !== -1 ) {
                            this.responseText = 'false';
                ...
                $("#client-create-validation").validate({
                    ...
                    messages: {
                        client_name: "Enter Client Business Name",
                        business_type: "Enter Client Business Type",
                        unique_identifier: {
                            required: "Enter an identifier for client",
                        ...
                        contact_name: "Please enter name of client prime contact",
                        contact_phone: {
