...
var BlankonTable = function () {
    ...
    return {
        ...
        datatable: function () {
            ...
            var tableDomClientListing = $('#datatable-client-listing');
            var tableDomClientSetupConfigure = $('#datatable-setup-configure');
            var tableDomClientProfile = $('#datatable-client-profile');
            var tableDomVatHold = $('#datatable-vat-hold');
            ...
            tableDomClientListing.dataTable({
                ...
                preDrawCallback: function () {
                    // Initialize the responsive datatables helper once.
                    if (!responsiveHelperDom) {
                        responsiveHelperDom = new ResponsiveDatatablesHelper(tableDomClientListing, breakpointDefinition);
                    }
                },
                rowCallback    : function (nRow) {
                    responsiveHelperDom.createExpandIcon(nRow);
            ...
            tableDomClientSetupConfigure.dataTable({
                autoWidth        : true,
                ...
                preDrawCallback: function () {
                    // Initialize the responsive datatables helper once.
                    if (!responsiveHelperDom) {
                        responsiveHelperDom = new ResponsiveDatatablesHelper(tableDomClientSetupConfigure, breakpointDefinition);
                    }
                },
                rowCallback    : function (nRow) {
                    responsiveHelperDom.createExpandIcon(nRow);
            ...
            tableDomVatHold.dataTable({
                ...
                preDrawCallback: function () {
                    // Initialize the responsive datatables helper once.
                    if (!responsiveHelperDom) {
                        responsiveHelperDom = new ResponsiveDatatablesHelper(tableDomVatHold, breakpointDefinition);
                    }
                },
                rowCallback    : function (nRow) {
                    responsiveHelperDom.createExpandIcon(nRow);
            ...
            tableDomClientProfile.dataTable({
                autoWidth        : false,
                ...
                preDrawCallback: function () {
                    // Initialize the responsive datatables helper once.
                    if (!responsiveHelperDom) {
                        responsiveHelperDom = new ResponsiveDatatablesHelper(tableDomClientProfile, breakpointDefinition);
                    }
                },
                rowCallback    : function (nRow) {
                    responsiveHelperDom.createExpandIcon(nRow);
