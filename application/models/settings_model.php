...
class Settings_model extends CI_Model {
	...
	{
		$query = $this->db->select('*')->from('vendor_to_ec_id')->join('client', 'client.id = vendor_to_ec_id.ec_id')->join('vendors', 'vendors.vendor_id = vendor_to_ec_id.vendor_id')->get()->result();
		return $query;
	}
