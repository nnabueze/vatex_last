...
class Settings extends CI_Controller {
	...
	{
		parent::__construct();
        $this->load->model(array('user_model','client_model','settings_model','basic_model'));
	...
	{		
		...
		$data = array();
		$data['datatable'] = TRUE;
		$data['page_title'] = 'Vendor Listing & Mapping';
		$data['uri_segment_2'] = 'settings';
		$data['uri_segment_3'] = 'vendor_listing';
		$data['vendor_listing'] = $this->settings_model->get_vendor_details();
		$data['page_content'] = '06_settings/vendor_listing_mapping';
		$this->load->view('includes/main_content', $data);
	}
	
	public function inputvat_tracker()
	{		
		if(!isAdminLoggedIn())
		{
			redirect(getUrl('login'));
		...
		$data = array();
		$data['datatable'] = TRUE;
		$data['page_title'] = 'Input VAT Tracker';
		$data['uri_segment_2'] = 'settings';
		$data['uri_segment_3'] = 'inputvat_tracker';
		//$data['inputvatorder_listing'] = $this->settings_model->get_vendor_details();
		$data['page_content'] = '06_settings/inputvat_tracker';
		$this->load->view('includes/main_content', $data);
	}
	/****** end of function *****/
