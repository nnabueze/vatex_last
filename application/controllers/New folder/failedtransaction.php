...
class failedtransaction extends CI_Controller {
	...
	public function index(){
		$data = array();
		$this->load->view('failedtransaction',$data);
	}

	public function getholddata(){
		$this->transaction_model->gettrnsactiondata(3);
	}

	public function viewdetails($id){
		$data = array();
		$data['vatdetails'] = $this->transaction_model->get_all_orders($id);
		$this->load->view('failtransactiondetails',$data);
	}
}