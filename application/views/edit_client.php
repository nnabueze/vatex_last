...
<form id="smart-form-register" name="smart-form-register" class="form-horizontal form-bordered"  method="post" action ="<?php echo site_url('client/edit_client/'.$client_detail[0]->id);?>" enctype="multipart/form-data">
							...
							<div class="form-group">
                                 <label class="col-sm-3 control-label">Company Name</label>
                                   <div class="col-md-6">
										<input type="text" name="companyname" placeholder="Client Company Name" value="<?php echo $client_detail[0]->companyname; ?>" >
									</div>
							</div>
							<div class="form-group">
                                 <label class="col-sm-3 control-label">Client Identifier</label>
                                   <div class="col-md-6">
										<input type="text" name="username" placeholder="Client Identifier" value="<?php echo $client_detail[0]->username; ?>" >
									</div>
							</div>
							...
							<div class="form-group">
                                 <label class="col-sm-3 control-label">Line of Business</label>
                                   <div class="col-md-6">
										<input type="text" name="clientbusiness" placeholder="Line of Client Business" value="<?php echo $client_detail[0]->clientbusiness; ?>" >
									</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
                                 <label class="col-sm-3 control-label">Prime Business Contact</label>
                                   <div class="col-md-6">
										<input type="text" name="pbcontact" placeholder="Prime Business Contact" value="<?php echo $client_detail[0]->pbcontact; ?>" >
									</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
                                 <label class="col-sm-3 control-label">VATEX Account Manager</label>
                                   <div class="col-md-6">
										<input type="text" name="amanager" placeholder="VATEX Account Manager" value="<?php echo $client_detail[0]->amanager; ?>">
								</div>
							</div>
							<div class="form-group">
                                 <label class="col-sm-3 control-label">Account Manager Email</label>
                                   <div class="col-md-6">
										<input type="text" name="amemail" placeholder="Account Manager Email" value="<?php echo $client_detail[0]->amemail; ?>">
								</div>
							</div>
						...
						<div class="form-footer">
                                            <div class="col-sm-offset-3">
                                                <button type="submit" name="editclient" value="Submit" class="btn btn-success">Submit</button>
                                            </div>
                                        </div><!-- /.form-footer -->
