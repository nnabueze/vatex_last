...
<section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-male"></i> Orders Listing <span>...to manage vat on holds</span></h2>
                                    ...
                                    <table id="datatable-listing" class="table table-striped table-primary table-middle table-project-clients">
                                        ...
                                        <tbody>
                                         <?php foreach($vatdetails as $clientdata){ 
											$userdata = $this->vat_model->get_user_name($clientdata->ec_id);
											//print_r($userdata);
											$bankdata = $this->vat_model->get_bank_name($clientdata->bankcode);
										 ?>
											<tr class="border-warning">
                                                ...
                                                <td class="text-center">
                                                    <a href="<?php echo site_url('vatonhold/refund/'.$clientdata->orderid.'/'.$clientdata->ec_id);?>" class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="top" data-original-title="Refund"><i class="fa fa-exchange"></i></a>
                                                </td>
                                            </tr>
											<?php } ?>
                                        </tbody>
