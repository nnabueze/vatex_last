...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <body class="page-sound">
        ...
        <div id="sign-wrapper">
            ...
            <!-- Login form -->
            <form class="sign-in form-horizontal shadow rounded no-overflow" action="<?php echo site_url('vendor/login');?>" method="post">
                ...
                <div class="sign-footer">
                    <div class="form-group">
						...
						<a href="login" title="Are you Vendor?" ><b>Are you Member?</b></a>
                    </div><!-- /.form-group -->
                </div><!-- /.sign-footer -->
