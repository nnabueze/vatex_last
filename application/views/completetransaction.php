...
<!-- START @PAGE CONTENT -->
            <section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-cogs"></i> Remitted VAT <span>...</span></h2>
                    <div class="breadcrumb-wrapper hidden-xs">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Remitted VAT</li>
                        </ol>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-8">
                            <div class="panel rounded shadow panel-default">
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <h3 class="panel-title">VAT Successfully Transfered</h3>
                                    </div>
                                    <div class="clearfix"></div>
                                </div><!-- /.panel-heading -->
		...
		<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				var dataTable = $('#tbltransaction').DataTable( {
					...
					"bFilter":false,
					"ajax":{
						url :"<?php echo base_url('completetransaction/getholddata'); ?>", // json datasource
				   ...
				   $('#tbltransaction tbody ').on( 'click', '#view', function () {
						...
						//alert(data[0]+'---'+data[4]);
						window.location.href = "<?php echo base_url('completetransaction/viewdetails/');?>/"+data[0];
					} );
