        ...
        <div class="col-md-12">
            <div class="panel rounded shadow">
                ...
                <div class="panel-body no-padding">
                    <form class="form-horizontal form-bordered" role="form" action="<?php echo site_url("reports/vendor_reports");?>" method="POST">
                        <div class="form-body">
                            ...
                            <table id="datatable-dom" class="table table-default table-middle table-striped table-bordered table-condensed">
                                ...
                                <tbody>
                                    <?php foreach($report as $report){
                                        $item['vendor_id'] = $report['Vendor_Id'];
                                        $item['ecommerce_id'] = $report['Ecommerce_Id'];
                                        $datas = $this->reports_model->vendor_computed_report($item);
                                        foreach($datas as $data){
                                            $name = $this->reports_model->ecommerce($data->ecommerce_id);
                                           ?>
                                           <tr class="border-warning">
                                            ...
                                            <td>
                                                <?php echo $data->transaction_amount; ?>
                                            </td>

                                            <td>
                                                <?php echo $data->input_vat; ?>
                                            </td>
                                            <td class="text-center">
                                                <?php echo $data->output_vat; ?></span>

                                            </td>
                                            <td class="text-center">
                                                <?php echo $data->net_vat; ?></span>
                            ...
                            <table id="datatable-dom" class="table table-default table-middle table-striped table-bordered table-condensed">
                                ...
                                <tbody>
                                    <?php foreach($report as $report){ 
                                        $item['vendor_id'] = $report['Vendor_Id'];
                                        $item['ecommerce_id'] = $report['Ecommerce_Id'];
                                        $datas = $this->reports_model->vendor_deducted_report($item);
                                        foreach($datas as $data){
                                            $name = $this->reports_model->ecommerce($data->ecommerce_id);
                                        ?>
                                    <tr class="border-warning">
