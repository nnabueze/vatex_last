                ...
                <div class="header-content">
                    ...
                    <div class="breadcrumb-wrapper hidden-xs">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Admin Onboarding</li>
                        </ol>
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-12">
                        	<div class="panel rounded shadow no-overflow">
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <h3 class="panel-title">Create New Admin Form</h3>
                                    </div>
...
<form id="smart-form-register" name="smart-form-register" class="form-horizontal form-bordered"  method="post" action ="<?php echo site_url('admin/add_admin');?>" enctype="multipart/form-data">
