...
<form id="smart-form-register" name="smart-form-register" class="form-horizontal form-bordered"  method="post" action ="<?php echo site_url('/profile_management');?>" enctype="multipart/form-data">
							...
							<div class="form-group">
                                 <label class="col-sm-3 control-label">First Name</label>
                                   <div class="col-md-6">
										<input type="text" name="firstname" placeholder="First name" value="<?php echo $user_detail[0]->first_name;?>" >
									</div>
							</div>
							...
							<div class="form-group">
                                 <label class="col-sm-3 control-label">Last Name</label>
                                   <div class="col-md-6">
										<input type="text" name="lastname" placeholder="Last name" value="<?php echo $user_detail[0]->last_name;?>" >
									</div>
							</div>
							...
							<div class="form-group">
                                 <label class="col-sm-3 control-label">Mobile</label>
                                   <div class="col-md-6">
										<input type="text" name="mobile" placeholder="Mobile No." value="<?php echo $user_detail[0]->mobile;?>">
								</div>
							</div>
							<div class="form-group">
                                 <label class="col-sm-3 control-label">User Type</label>
                                   <div class="col-md-6">
											...
											?>
											<?php if($user_detail[0]->user_group_id == $ug->id){ echo $ug->user_group; } ?>											<?php }?>
							...
							<div class="form-group">
                                 <label class="col-sm-3 control-label">
                            			<input type="file" name="pimg" placeholder="Profile Image" value="" ><b class="tooltip tooltip-bottom-right">Please choose your profile image</b></label>
							<div class="col-md-6">
											
								<?php if($userdt[0]->profile_img!=''){?>
										<a href="<?php echo base_url('uploads/'.$userdt[0]->profile_img);?>" target="_blank"><img src="<?php echo site_url('uploads/'.$userdt[0]->profile_img);?>" alt="me" width="100" height="100" /> </a>
