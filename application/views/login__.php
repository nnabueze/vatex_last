...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        ...
        <link href="<?php echo base_url('assets/main/assets/admin/css/themes/default.theme.css'); ?>" rel="stylesheet" id="theme">
        <link href="<?php echo base_url('assets/main/assets/admin/css/pages/sign.css'); ?>" rel="stylesheet">
    ...
    <body class="page-sound">
        ...
        <div id="sign-wrapper">
            ...
            <div class="brand">
				...
				<img class="logo" src="<?php echo base_url('assets/main/assets/global/img/logo.png'); ?>" height="100" width="220">
            </div>
            <!--/ Brand -->

            <!-- Login form -->
            <form class="sign-in form-horizontal shadow rounded no-overflow" action="<?php echo site_url('login');?>" method="post">
                ...
                <div class="sign-footer">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-theme btn-lg btn-block no-margin rounded" id="login-btn">Sign In</button>
						 ...
						 <a href="vendor/login" title="Are you Vendor?" ><b>Are you Vendor?</b></a>
                    </div><!-- /.form-group -->
                </div><!-- /.sign-footer -->
        ...
        <script src="<?php echo base_url('assets/main/assets/global/plugins/bower_components/jquery-validation/dist/jquery.validate.min.js'); ?>"></script>
        <!--/ END PAGE LEVEL PLUGINS -->

        <!-- START @PAGE LEVEL SCRIPTS -->
        <script src="<?php echo base_url('assets/main/assets/admin/js/pages/blankon.sign.js'); ?>"></script>
